...
if __name__ == '__main__':
    ...
    for epoch in range(1, epochs + 1):
        ...
        generator.save_weights(
            'generate_models/mnist/params_generator_epoch_{0:03d}.hdf5'.format(epoch), True)
        discriminator.save_weights(
            'generate_models/mnist/params_discriminator_epoch_{0:03d}.hdf5'.format(epoch), True)
        ...
        Image.fromarray(img).save(
            'generate_models/mnist/plot_epoch_{0:03d}_generated.png'.format(epoch))
    generator.save('generate_models/mnist/ACGAN_mnist_keras200.h5')
