...
def get_parser():
    ...
    parser.add_argument('--checkpoint_dir', type=str, default="student_models/checkpoint_dir_adv_w_4")
    parser.add_argument('--log_dir', type=str, default="logs")
    parser.add_argument('--gpu', type=int, default=1, choices=[None, 0, 1])

    # Training Parameters
    parser.add_argument('--load_teacher_from_checkpoint', type=str, default="false")
    parser.add_argument('--load_teacher_checkpoint_dir', type=str, default="teacher_models/checkpoint_dir_adv_w_8")
    parser.add_argument('--model_type', type=str, default="student", choices=["teacher", "student"])
...
def main():
    ...
    if args.model_type == "student":
        ...
        if args.load_teacher_from_checkpoint:
            teacher_model = model.TModel(args, "teacher")
        ...
        student_model = model.SModel(args, "student")
